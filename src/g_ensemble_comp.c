...
int main(int argc, char *argv[]) {
	const char *desc[] = {
		...
		" and small number of frames may not provide a good representation of the ensemble.",
		...
		"By default, differences are estimated for all atoms, but comparisons can be done for a smaller specific group of atoms,",
